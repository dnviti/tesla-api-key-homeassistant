...
Nginx serves the Tesla key path directly and proxies all other requests to `homeassistant_url`. Point your public reverse proxy at this add-on's mapped host port to keep the same external Home Assistant URL.
