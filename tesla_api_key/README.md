...
Configuration uses Home Assistant's raw configuration/code editor. Folded YAML (`key_pem: >-`) and wrapped base64 are normalized back to valid PEM format at startup.
